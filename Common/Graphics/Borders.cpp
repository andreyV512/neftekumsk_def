...
//------------------------------------------------------------------
VBorder::VBorder(Chart &c) : chart(c), color(0xffff00ff), value(0.0), penWidth(2)
{}
//-----------------------------------------------------------------
void VBorder::Draw()
{
	Color col(color);
	Pen pen(col, (REAL)penWidth);
	...
	double x =  chart.rect.left + chart.offsetAxesLeft + (value - chart.minAxesX) * dX - 0.5 * dX;
